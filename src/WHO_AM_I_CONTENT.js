  ...
  translations: {
    ...
    es: {
      ...
      bioParagraphs: [
        ...
        "Mas alla del deporte, estoy cursando el programa universitario de primer ano del MIT y ahora voy por Linear Algebra (18.06), junto con Foundations of Modern Finance I a traves de edX. El algebra lineal me atrae por mi amor a las matematicas puras. Lo que encuentro elegante en las matematicas es como conceptos simples se encadenan hasta formar marcos muy poderosos, y como operaciones basicas con vectores se relacionan con todo, desde los graficos 3D hasta los algoritmos de aprendizaje automatico. Las finanzas me atraen porque quiero entender los marcos cuantitativos que hay detras de los sistemas politicos y economicos que he observado. Incluso solo entre Budapest y Mallorca, he visto de primera mano como las politicas afectan a comunidades distintas de maneras muy diferentes. Tambien he aprendido programacion (HTML, CSS, React, JavaScript y actualmente Python y C++) para crear herramientas que resuelvan problemas practicos. Por ejemplo, cree un pipeline que convierte texto escrito a maquina en mi letra manuscrita. Esto ha eliminado mas de 60 horas de transcripcion tediosa en los ultimos tres meses, tiempo que he redirigido a un trabajo mas significativo.",
      ],
    ...
    fr: {
      ...
      bioParagraphs: [
        ...
        "Au-dela du sport, je suis le programme universitaire de premiere annee du MIT et j'en suis actuellement a Linear Algebra (18.06), en parallele de Foundations of Modern Finance I via edX. L'algebre lineaire me plait pour son elegance en mathematiques pures. Ce que je trouve beau dans les mathematiques, c'est la maniere dont des concepts simples se transforment en cadres tres puissants, et dont des operations elementaires sur les vecteurs sont liees a tout, des graphismes 3D aux algorithmes d'apprentissage automatique. La finance m'interesse parce que je veux comprendre les cadres quantitatifs qui sous-tendent les systemes politiques et economiques que j'ai observes. Rien qu'entre Budapest et Majorque, j'ai vu de mes propres yeux comment les politiques affectent des communautes differentes de facons tres differentes. J'ai aussi appris la programmation (HTML, CSS, React, JavaScript, et actuellement Python et C++) afin de construire des outils qui resolvent des problemes concrets. Par exemple, j'ai cree un pipeline qui convertit du texte tape en ma propre ecriture manuscrite. Cela m'a permis d'eliminer plus de 60 heures de transcription fastidieuse au cours des trois derniers mois, temps que j'ai pu consacrer a un travail plus utile.",
      ],
    ...
    de: {
      ...
      bioParagraphs: [
        ...
        "Neben dem Sport absolviere ich das Hochschulprogramm des ersten Studienjahres am MIT und arbeite derzeit an Linear Algebra (18.06) sowie an Foundations of Modern Finance I uber edX. Lineare Algebra spricht mich wegen meiner Liebe zur reinen Mathematik an. Was ich an Mathematik elegant finde, ist, wie sich einfache Konzepte zu kraftvollen Frameworks aufbauen und wie grundlegende Vektoroperationen mit allem zusammenhangen, von 3D-Grafik bis zu Machine-Learning-Algorithmen. Finanzen interessieren mich, weil ich die quantitativen Frameworks hinter den politischen und wirtschaftlichen Systemen verstehen will, die ich beobachtet habe. Schon allein zwischen Budapest und Mallorca habe ich aus erster Hand gesehen, wie politische Entscheidungen verschiedene Gemeinschaften auf sehr unterschiedliche Weise beeinflussen. Ich habe auch Programmierung gelernt (HTML, CSS, React, JavaScript und derzeit Python und C++), um Werkzeuge zu bauen, die praktische Probleme losen. Zum Beispiel habe ich eine Pipeline erstellt, die getippten Text in meine Handschrift umwandelt. Dadurch konnte ich in den letzten drei Monaten mehr als 60 Stunden monotone Abschreibarbeit vermeiden und diese Zeit auf sinnvollere Arbeit verlagern.",
      ],
    ...
    hu: {
      ...
      bioParagraphs: [
        ...
        "A sporton tul az MIT elso eves egyetemi programjat vegzem, es jelenleg a Linear Algebra (18.06) kurzusnal tartok, a Foundations of Modern Finance I kurzussal parhuzamosan az edX-en. A linearis algebra a tiszta matematika iranti szeretetem miatt vonz. A matematikaban azt talalom elegansnak, ahogy az egyszeru fogalmak eros keretrendszerekke epulnek, es ahogy az alapveto vektormuveletek a 3D grafikaktol a gepi tanulasi algoritmusokig mindenhez kapcsolodnak. A penzugy azert erdekel, mert meg akarom erteni azoknak a politikai es gazdasagi rendszereknek a kvantitativ kereteit, amelyeket megfigyeltem. Mar csak Budapest es Mallorca kozott is kozvetlenul lattam, hogy a szakpolitikak milyen kulonbozo modon hatnak a kulonbozo kozossegekre. A programozast is megtanultam (HTML, CSS, React, JavaScript, es jelenleg Python es C++), hogy olyan eszkozoket epithessek, amelyek gyakorlati problemakat oldanak meg. Peldaul keszitettem egy pipeline-t, amely a gepelt szoveget a sajat kezirasomma alakitja. Ez az elmult harom honapban tobb mint 60 ora faraszto masolasi munkat szuntetett meg, es ezt az idot ertelmesebb munkara tudtam atiranyitani.",
      ],
